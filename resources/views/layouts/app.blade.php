  ...
  <div class="sidebar">
   ...
   <br>
    <a href="{{ route('dashboard.index') }}"><i class="bi bi-house-door"></i>
      ...
      Dashboard</a>
    <a href="{{ route('products.index') }}"><i class="bi bi-bag-plus"></i>
      ...
      Products</a>
    <a href="{{ route('categories.index') }}"><i class="bi bi-grid"></i>
    ...
    <a href="  {{ route('users.index') }}"><i class="bi bi-people"></i>
      ...
      <a href=" {{ route('orders.index') }}"><i class="<i class="bi bi-cart-check"></i>
